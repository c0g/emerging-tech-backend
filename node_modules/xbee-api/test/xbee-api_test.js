...
/*
  'ZigBee IO Data Sample Rx. DIO0 enabled and DIO3 disabled, with temp sensor going into DIO0': function(test) {
    test.expect(2);
    var xbeeAPI = new xbee_api.XBeeAPI();
    var parser = xbeeAPI.rawParser();
    xbeeAPI.once("frame_object", function(frame) {
    ...
    var rawFrame = new Buffer([ 0x7e, 0x00, 0x12, 0x92, 0x00, 0x13, 0xa2, 0x00, 0x40, 0xb0, 0x99, 0x70, 0x6a, 0x31, 0x01, 0x01, 0x00, 0x00, 0x01, 0x02, 0x5a, 0xc5 ]);
    parser(null, rawFrame);
  },
  'ZigBee IO Data Sample Rx. DIO0 and DIO3 enabled with temp sensor going into DIO0': function(test) {
    test.expect(2);
    var xbeeAPI = new xbee_api.XBeeAPI();
    var parser = xbeeAPI.rawParser();
    xbeeAPI.once("frame_object", function(frame) {
    ...
    var rawFrame = new Buffer([ 0x7e, 0x00, 0x14, 0x92, 0x00, 0x13, 0xa2, 0x00, 0x40, 0xb0, 0x99, 0x70, 0x6a, 0x31, 0x01, 0x01, 0x00, 0x00, 0x09, 0x02, 0x5f, 0x02, 0x0f, 0xa7 ]);
    parser(null, rawFrame);
  },
  'ZigBee IO Data Sample Rx. DIO0 disabled and DIO3 enabled, with temp sensor going into DIO3': function(test) {
    test.expect(2);
    var xbeeAPI = new xbee_api.XBeeAPI();
    var parser = xbeeAPI.rawParser();
    xbeeAPI.once("frame_object", function(frame) {
    ...
    var rawFrame = new Buffer([ 0x7e, 0x00, 0x12, 0x92, 0x00, 0x13, 0xa2, 0x00, 0x40, 0xb0, 0x99, 0x70, 0x6a, 0x31, 0x01, 0x01, 0x00, 0x00, 0x08, 0x02, 0x63, 0xb5 ]);
    parser(null, rawFrame);
  },
  'ZigBee IO Data Sample Rx. DIO0 and DIO3 enabled with temp sensor going into DIO3': function(test) {
    test.expect(2);
    var xbeeAPI = new xbee_api.XBeeAPI();
    var parser = xbeeAPI.rawParser();
    xbeeAPI.once("frame_object", function(frame) {
    ...
    var rawFrame = new Buffer([ 0x7e, 0x00, 0x14, 0x92, 0x00, 0x13, 0xa2, 0x00, 0x40, 0xb0, 0x99, 0x70, 0x6a, 0x31, 0x01, 0x01, 0x00, 0x00, 0x09, 0x02, 0x10, 0x02, 0x63, 0xa2 ]);
    parser(null, rawFrame);
  },
*/
